            ...
            <div className="add-employee-container">
              ...
              <form className="employee-form" onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="form-row">
                  <div className="form-group">
                    <label>Name*</label>
                    <input type="text" name="name" value={form.name} onChange={handleChange} placeholder="Enter The Name..." />
                  </div>
                  <div className="form-group">
                    <label>Role*</label>
                    <input type="text" name="Role" value={form.Role} onChange={handleChange} placeholder="Enter The Role..." />
                  </div>
                </div>
                ...
                <div className="form-row">
                  <div className="form-group">
                    <label>Department*</label>
                    <input type="text" name="Department" value={form.Department} onChange={handleChange} placeholder="Enter The Department..." />
                  </div>
                  <div className="form-group">
                    <label>Mobile*</label>
                    <input type="text" name="Mobile" value={form.Mobile} onChange={handleChange} placeholder="Enter The Mobile..." />
                  </div>
                </div>
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    <label>Email*</label>
                    <input type="Email" name="Email" value={form.Email} onChange={handleChange} placeholder="Enter The Email..." />
                  </div>
                </div>
